...
// // Coloque a função setDinoLose fora do componente Dino
// let dinoElementGlobal = null;

// export const setDinoLose = () => {
//   if (dinoElementGlobal) {
//     dinoElementGlobal.src = `imgs/dino-lose.png`;
//   }
// };
...
//   dinoElementGlobal = dinoElement.current; // Atualiza a referência global
...
//     // window.setDinoLose = setDinoLose
...
// // export { updateDino }; // Exporta as funções setDinoLose e updateDino para serem utilizadas em outros arquivos
